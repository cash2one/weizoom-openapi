        ...
        try:
            ...
            if resp['data']:
                ...
                for catalog1 in catalog_level_1:
                    level1['first_level_id'] = catalog1['id']
                    level1['first_level_name'] = catalog1['name']
                ...
                data['errcode'] = PRODUCT_CATALOGS_IS_NULL_CODE
                data['errmsg'] = code2msg[PRODUCT_CATALOGS_IS_NULL_CODE]
            return data
        except:
            data['errcode'] = FAIL_GET_PRODUCT_CATALOGS_CODE
            data['errmsg'] = code2msg[FAIL_GET_PRODUCT_CATALOGS_CODE]
